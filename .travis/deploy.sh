...
docker buildx build --progress plain --platform linux/386,linux/amd64,linux/arm/v6,linux/arm/v7,linux/arm64/v8 -t "psyciknz/cameraevents:$DOCKER_IMAGE_TAG" --push .
